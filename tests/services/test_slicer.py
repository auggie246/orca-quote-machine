...
class TestOrcaSlicerService:
    ...
    def test_get_profile_paths_default(self):
    ...
    def test_get_profile_paths_specific_material(self):
    ...
    def test_get_profile_paths_missing_file(self):
    ...
    @pytest.mark.asyncio
    async def test_slice_model_file_not_found(self):
    ...
    @pytest.mark.asyncio
    async def test_slice_model_success(self, mocker):
    ...
    @pytest.mark.asyncio
    async def test_slice_model_cli_failure(self, mocker):
    ...
    @pytest.mark.asyncio 
    async def test_slice_model_timeout(self, mocker):
    ...
    @pytest.mark.asyncio
    async def test_parse_gcode_metadata_success(self):
...
"""
    ...
    @pytest.mark.asyncio
    async def test_parse_gcode_metadata_no_metadata(self):
...
"""
    ...
    def test_parse_time_string_hours_and_minutes(self):
    ...
    def test_parse_time_string_minutes_only(self):
    ...
    @pytest.mark.asyncio
    async def test_parse_slice_results_no_gcode(self):
    ...
    @pytest.mark.asyncio
    async def test_parse_slice_results_with_json(self, mocker):
