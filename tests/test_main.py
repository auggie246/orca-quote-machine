...
class TestHomeEndpoint:
    ...
    def test_home_page_returns_html(self, client: TestClient):
...
class TestQuoteEndpoint:
    ...
    def test_create_quote_no_file(self, client: TestClient, sample_quote_data: dict):
...
class TestTaskStatusEndpoint:
    ...
    def test_get_task_status_pending(self, client: TestClient, mocker):
    ...
    def test_get_task_status_success(self, client: TestClient, mocker):
    ...
    def test_get_task_status_failure(self, client: TestClient, mocker):
